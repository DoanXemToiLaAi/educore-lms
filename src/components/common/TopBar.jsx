  ...
  return (
    <nav className="flex items-center justify-between px-6 py-4 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700 shadow-sm">
      <div className="flex items-center gap-4">
        ...
        <form className={`relative transition-all duration-300 ${isSearchShow ? "w-80" : "w-64"}`}>
          <div className="relative">
            ...
            <button
              ...
              <i className={`bx ${isSearchShow ? "bx-x" : "bx-search"} text-gray-500 dark:text-gray-400`}></i>
            </button>
          </div>
        </form>
      </div>
