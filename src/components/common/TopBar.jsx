    ...
    <nav className="navbar" >
      ...
      <form action="#" className={`navbar-form${isSearchShow ? ' show' : ''}`}> 
        <div className="form-input">
          ...
          <button className="search-btn" style={{border: '1px solid var(--light)'}} type="submit" onClick={onSearchBtnClick}>
      ...
      >
        {isDarkTheme ? (
          <i className="bx bx-moon" style={{ fontSize: 22, color: '#1976D2', transition: 'color 0.2s' }}></i>
        ) : (
          <i className="bx bx-sun" style={{ fontSize: 22, color: '#FFD600', transition: 'color 0.2s' }}></i>
        )}
      </button>
