          ...
          datasets: [
            {
              label: "Miền Bắc",
              data: [
                120, 145, 167, 189, 210, 234, 256, 278, 301, 325, 348, 372,
              ],
              borderColor: "#1E3A8A",
            ...
            },
            {
              label: "Miền Nam",
              data: [
                200, 225, 251, 278, 305, 332, 359, 386, 413, 440, 467, 494,
              ],
              borderColor: "#388E3C",
    ...
    <div className="w-full text-gray-800 dark:text-gray-200">
      ...
      <div className="mb-8">
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm p-6 h-96 flex items-center justify-center">
          <canvas
            ref={tenantGrowthRef}
            className="w-full h-80 max-h-80"></canvas>
        </div>
      </div>
        ...
        <div className="mb-6">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Theo dõi hiệu năng và sử dụng tài nguyên
            </p>
          </div>
        </div>
              ...
              <tbody>
                <tr className="border-b border-gray-100 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700">
                  ...
                  <td className="py-3 px-2 text-sm text-gray-600 dark:text-gray-400">
                    Tạo Tenant (Sở GD&ĐT Quảng Ninh)
                  </td>
                  <td className="py-3 px-2 text-sm text-gray-600 dark:text-gray-400">
                    16-07-2025 09:15
                  </td>
                ...
                <tr className="border-b border-gray-100 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700">
                  ...
                  <td className="py-3 px-2 text-sm text-gray-600 dark:text-gray-400">
                    Gán quyền Admin trường (User123)
                  </td>
                  <td className="py-3 px-2 text-sm text-gray-600 dark:text-gray-400">
                    15-07-2025 16:30
                  </td>
            ...
            <table className="w-full">
              ...
              <tbody>
                <tr className="border-b border-gray-100 dark:border-gray-700 hover:bg-red-50 dark:hover:bg-red-900/20">
                  <td className="py-3 px-2 text-sm font-medium text-gray-800 dark:text-gray-200">
                    #1285
                  </td>
                  <td className="py-3 px-2 text-sm text-gray-600 dark:text-gray-400">
                    Server database không phản hồi - ảnh hưởng 15 trường
                  </td>
                  <td className="py-3 px-2 text-sm text-gray-600 dark:text-gray-400">
                    Monitoring System
                  </td>
                ...
                <tr className="border-b border-gray-100 dark:border-gray-700 hover:bg-red-50 dark:hover:bg-red-900/20">
                  ...
                  <td className="py-3 px-2 text-sm text-gray-600 dark:text-gray-400">
                    Yêu cầu tăng quota storage từ 100GB lên 500GB
                  </td>
                  <td className="py-3 px-2 text-sm text-gray-600 dark:text-gray-400">
                    Sở GD&ĐT Hà Nội
                  </td>
                ...
                <tr className="border-b border-gray-100 dark:border-gray-700 hover:bg-yellow-50 dark:hover:bg-yellow-900/20">
                  ...
                  <td className="py-3 px-2 text-sm text-gray-600 dark:text-gray-400">
                    Lỗi cấu hình SMTP - không gửi được email thông báo
                  </td>
                  <td className="py-3 px-2 text-sm text-gray-600 dark:text-gray-400">
                    Trường THPT ABC
                  </td>
                ...
                <tr className="border-b border-gray-100 dark:border-gray-700 hover:bg-yellow-50 dark:hover:bg-yellow-900/20">
                  ...
                  <td className="py-3 px-2 text-sm text-gray-600 dark:text-gray-400">
                    Yêu cầu tích hợp API với hệ thống quản lý học sinh
                  </td>
                  <td className="py-3 px-2 text-sm text-gray-600 dark:text-gray-400">
                    Sở GD&ĐT TP.HCM
                  </td>
                ...
                <tr className="border-b border-gray-100 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700">
                  ...
                  <td className="py-3 px-2 text-sm text-gray-600 dark:text-gray-400">
                    Yêu cầu thêm tính năng báo cáo tùy chỉnh
                  </td>
                  <td className="py-3 px-2 text-sm text-gray-600 dark:text-gray-400">
                    Trường THCS XYZ
                  </td>
                ...
                <tr className="hover:bg-gray-50 dark:hover:bg-gray-700">
                  ...
                  <td className="py-3 px-2 text-sm text-gray-600 dark:text-gray-400">
                    Hướng dẫn cách tạo lớp học ảo cho giáo viên mới
                  </td>
                  <td className="py-3 px-2 text-sm text-gray-600 dark:text-gray-400">
                    Giáo viên Nguyễn A
                  </td>
