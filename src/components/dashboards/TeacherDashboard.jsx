  ...
  return (
    <div className="font-poppins p-9 bg-gray-50 dark:bg-gray-900 w-full text-gray-800 dark:text-gray-200">
      ...
      <div className="flex items-center justify-between mb-5">
        <div>
          ...
          <ul className="flex items-center gap-4 mt-1">
            <li className="text-gray-600 dark:text-gray-400 text-base pointer-events-none">
              Tổng quan giáo viên
            </li>
          </ul>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 mb-6">
        {stats.map((stat, idx) => (
          <div
            className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm h-28 flex flex-col justify-center items-center p-4"
            key={stat.label}>
            <div className="flex items-center gap-4 mb-2 w-full justify-center">
              <i
                ...
                style={{ color: stat.color, background: stat.bg }}></i>
              <div>
                <h3 className="text-3xl font-bold m-0 text-blue-600">
                  {stat.value}
                </h3>
                <p className="m-0 text-gray-600 dark:text-gray-400 text-lg font-semibold">
                  {stat.label}
                </p>
                ...
                <div className="space-y-2 max-h-64 overflow-y-auto">
                  {day.lessons.map((lesson, lessonIdx) => {
                    ...
                    if (lesson.status === "completed") {
                      ...
                      statusClasses =
                        "bg-blue-50 dark:bg-blue-900/30 border-blue-200 dark:border-blue-700 animate-pulse";
                      statusIndicator = "●";
                    }
                    ...
                    return (
                      <div
                        key={lessonIdx}
                        className={`p-3 rounded-lg border ${statusClasses} hover:shadow-sm transition-shadow`}>
                        ...
                        <div
                          className={`text-sm font-medium text-right mt-1 ${
            ...
            <table className="w-full border-collapse text-base">
              <thead>
                <tr className="border-b border-gray-200 dark:border-gray-700">
                  <th className="text-left py-3 px-2 text-gray-600 dark:text-gray-400 font-semibold">
                    Họ tên
                  </th>
                  <th className="text-left py-3 px-2 text-gray-600 dark:text-gray-400 font-semibold">
                    Lớp
              ...
              return (
                <li
                  ...
                  className={`p-3 rounded-lg ${
                    statusClasses.includes("bg-gray")
                      ? statusClasses
                      : statusClasses.split(" ")[0] +
                        " " +
                        statusClasses.split(" ")[1]
                  } flex items-center gap-3`}>
                  <i
                    className={`bx ${a.icon} text-xl text-gray-600 dark:text-gray-400`}></i>
